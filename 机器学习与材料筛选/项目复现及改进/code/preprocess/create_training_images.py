...
parser.add_argument('--image', default=r'D:\output\example_10.tif',help='path to image')
parser.add_argument('--name', default='test',help='name of dataset')
parser.add_argument('--edgelength', type=int, default=64, help='input batch size')
parser.add_argument('--stride', type=int, default=32, help='the height / width of the input image to network')
parser.add_argument('--target_dir', default=r'D:\output\training_images',help='path to store training images')
